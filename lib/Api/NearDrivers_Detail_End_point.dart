...
class NearDiverList {
  ...
  static Future<List<User>> neardriverlist(String token, double longtiude,
      double latitude, BuildContext context) async {
    //Adding New
    final prefs = await SharedPreferences.getInstance();
    final response = await http.get(
      Uri.parse(AppColors.BaseUrl +
          "api/drivers/nearby?longitude=$longtiude.76&latitude=$latitude"),
      headers: {
